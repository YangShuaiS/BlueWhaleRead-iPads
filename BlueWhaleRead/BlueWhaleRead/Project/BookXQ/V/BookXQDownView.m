...
-(void)setupUI{
    ...
    Lefttview.layer.cornerRadius = LENGTH(24);
    [self addSubview:Lefttview];
    [Lefttview mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(ws);
        make.centerX.mas_equalTo(ws).with.offset(LENGTH(-LENGTH(103)-LENGTH(28)));
        make.width.mas_equalTo(LENGTH(206));
        make.height.mas_equalTo(LENGTH(48));
    }];
    
    leftLabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@"答题"];
    ...
    rightview.layer.cornerRadius = LENGTH(24);
    ...
    RightLabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@"加入书架"];
...
//    [UIView animateWithDuration:0.5 animations:^{
        ...
        [self->RightLabel mas_updateConstraints:^(MASConstraintMaker *make) {
            make.centerX.mas_equalTo(self->rightview.mas_centerX).with.offset(LENGTH(10));
        }];
        [self->rightImageView mas_updateConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(self->rightview.mas_left).with.offset(LENGTH(50));
        }];
...
- (void)yidu{
    ...
    [self->leftLabel mas_updateConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self->Lefttview.mas_centerX).with.offset(LENGTH(10));
    }];
    [self->leftImageView mas_updateConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self->Lefttview.mas_left).with.offset(LENGTH(50));
    }];
