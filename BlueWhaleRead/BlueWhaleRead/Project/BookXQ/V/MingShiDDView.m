...
-(void)setupUI{
    ...
    subtitle = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:LinShiZiTiYanSe LabelFont:TextFont(16) TextAlignment:NSTextAlignmentLeft Text:@""];
    ...
    [subtitle mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self->name.mas_bottom).with.offset(LENGTH(26));
    }];
