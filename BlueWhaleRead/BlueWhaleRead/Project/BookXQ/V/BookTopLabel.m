...
- (void)addview{
    _longlabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:subtitleColor LabelFont:TextFont(Font16) TextAlignment:NSTextAlignmentLeft Text:[NSString stringWithFormat:@""]];
