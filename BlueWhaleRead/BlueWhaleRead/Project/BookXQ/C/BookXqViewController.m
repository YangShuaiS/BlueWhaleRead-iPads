...
- (void)viewDidLoad {
    ...
    [bookTop mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(backImageView.mas_top).with.offset(LENGTH(5)+StatusBar+44);
...
//        make.bottom.mas_equalTo(self->downView.mas_top).with.offset(LENGTH(16));
        make.left.mas_equalTo(self->bookTop.mas_left).with.offset(LENGTH(40));
...
//        make.bottom.mas_equalTo(self->downView.mas_top).with.offset(LENGTH(12));
        make.right.mas_equalTo(self->bookTop.mas_right).with.offset(-LENGTH(40));
        make.width.mas_equalTo(LENGTH(12));
        make.height.mas_equalTo(LENGTH(47));
...
- (void)addIntensiveMenu:(BookXQModel*)model{
    ...
    [homeMenu mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self->downView.mas_top).with.offset(LENGTH(15));
    ...
    if (flo>50&& big == NO){
        ...
        [UIView animateWithDuration:0.5 animations:^{
            [self->bookTop mas_updateConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(self->bacImageview.mas_top).with.offset(-self->bookTop.frame.size.height+StatusBar+44);
            }];
        ...
        [UIView animateWithDuration:0.5 animations:^{
            [self->bookTop mas_updateConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(self->bacImageview.mas_top).with.offset(LENGTH(5)+StatusBar+44);
            }];
            [self.view.superview layoutIfNeeded];
        } completion:^(BOOL finished) {
