...
- (void)addView{
    ...
    title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(35,100,96) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:@""];
    ...
    subtitle = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(92,135,133) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@""];
