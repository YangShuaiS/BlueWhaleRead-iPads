...
- (void)addView{
    ...
    title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(35,100,96) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:@"你已经把人文勋章指定的20本书全部加入书架了"];
