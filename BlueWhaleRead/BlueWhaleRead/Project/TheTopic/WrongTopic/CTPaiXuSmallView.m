...
-(void)setupUI{
    ...
    [_tableView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->tiMu.mas_bottom).with.offset(LENGTH(42));
        make.left.equalTo(ws).with.offset(LENGTH(161));
        make.right.equalTo(ws).with.offset(-LENGTH(109));
    ...
    [leftView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(ws.tableView.mas_left).with.offset(-LENGTH(20));
