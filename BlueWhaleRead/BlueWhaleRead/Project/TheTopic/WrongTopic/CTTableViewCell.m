...
- (void)addview{
    ...
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255, 255, 255) LabelFont:TextFont(LENGTH(22)) TextAlignment:NSTextAlignmentCenter Text:@"案我是答案我是答案我是答案我是答案案我是答案我是答案我是答案我是答"];
    Title.numberOfLines = 0;
    [view addSubview:Title];
    WS(ws);
    [view mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(ws).with.offset(-LENGTH(40));
        make.bottom.equalTo(ws).with.offset(-LENGTH(24));
    ...
    [Title mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self->view.mas_right).with.offset(-LENGTH(30));
        //        make.bottom.equalTo(self->  ).with.offset(-LENGTH(28));
        //        make.top.equalTo(self->view.mas_top).with.offset(LENGTH(28));
        make.left.equalTo(self->view.mas_left).with.offset(LENGTH(30));
...
- (void)layoutSubviews{
    ...
    view.layer.cornerRadius = (self.frame.size.height - LENGTH(24))/2;
