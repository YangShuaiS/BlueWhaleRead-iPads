...
- (void)addView{
    ...
    self.layer.cornerRadius = LENGTH(30);
    
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(85, 137, 230) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@"案我是答案我是答案我是答案我是答案案我是答案我是答案我是答案我是答"];
