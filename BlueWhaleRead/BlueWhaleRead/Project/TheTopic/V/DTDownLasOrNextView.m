...
- (void)addBaack{
    ...
    BaseLabel * Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@"返回我的书架"];
...
- (void)PushView{
    [lasttopic mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self->downView.mas_centerX).with.offset(-LENGTH(108));
    ...
    [RJOrFanHuiBookCity mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self->downView.mas_centerX).with.offset(LENGTH(138));
        make.centerY.mas_equalTo(self->downView.mas_centerY);
        make.width.mas_equalTo(LENGTH(220));
        make.height.mas_equalTo(LENGTH(50));
    }];
...
- (void)addTJ{
    ...
    BaseLabel * Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@"提交答案"];
...
- (void)addLast{
    ...
    BaseLabel * Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@"上一题"];
    Title.numberOfLines = 0;
