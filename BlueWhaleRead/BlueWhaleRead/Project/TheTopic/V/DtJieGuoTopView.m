...
- (void)addView{
    ...
    [topImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self->backView.mas_top).with.offset(StatusBar+44+LENGTH(18));
        make.width.mas_equalTo(LENGTH(130));
        make.height.mas_equalTo(LENGTH(130));
    }];
}
...
- (void)DTJGYES{
    ...
    BaseLabel * jg = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(241,247,247) LabelFont:TextFont(33) TextAlignment:NSTextAlignmentCenter Text:@"同学，恭喜你答题成功！"];
    [backView addSubview:jg];
    [jg mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(ws);
        make.top.mas_equalTo(self->topImageView.mas_bottom).with.offset(LENGTH(25));
    }];
    
    
    BaseLabel * hqjf = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(241,247,247) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentCenter Text:[NSString stringWithFormat:@"获得积分：%ld",_models.score]];
    [backView addSubview:hqjf];
    [hqjf mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(ws);
        make.top.mas_equalTo(jg.mas_bottom).with.offset(LENGTH(42));
    }];
    
    BaseLabel * zjf = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(241,247,247) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentCenter Text:[NSString stringWithFormat:@"总积分：%ld",_models.totalScore]];
    [backView addSubview:zjf];
    [zjf mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(ws);
        make.top.mas_equalTo(hqjf.mas_bottom).with.offset(LENGTH(22));
        make.bottom.mas_equalTo(self->backView.mas_bottom).with.offset(-LENGTH(65));
    }];
    [self addjg];
    ...
    if (_cuotiarray.count == 0) {
        ...
        [POPBookCity mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(self->zql.mas_bottom).with.offset(LENGTH(40));
            make.centerX.mas_equalTo(ws);
        ...
        [CKCT mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(self->zql.mas_bottom).with.offset(LENGTH(40));
            make.centerX.mas_equalTo(ws).with.offset(-LENGTH(22)-LENGTH(100));
            make.width.mas_equalTo(LENGTH(200));
            make.height.mas_equalTo(LENGTH(50));
        }];
    ...
    if (_models.badgeBooks.count == 0) {
        ...
        if (_models.studentBadgeNum >= _models.badgeNum) {
            ...
            BaseLabel * xunzhang = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(4,51,50) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:str];
...
- (void)DTJGNO{
    ...
    BaseLabel * jg = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(241,247,247) LabelFont:TextFont(33) TextAlignment:NSTextAlignmentCenter Text:@"哎呀，答题失败了，继续努力哟！"];
    [backView addSubview:jg];
    [jg mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(ws);
        make.top.mas_equalTo(self->topImageView.mas_bottom).with.offset(LENGTH(25));
    ...
    BaseLabel * zhangtai = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(241,247,247) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentCenter Text:@""];
...
- (void)addjg{
    WS(ws);
    BaseLabel * time = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(4,51,50) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:[NSString stringWithFormat:@"%@答题中用时：%@",_models.bookName,_secont]];
    [backView addSubview:time];
    [time mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(ws);
        make.top.mas_equalTo(self->backView.mas_bottom).with.offset(LENGTH(40));
    }];
    
    CGFloat fen = 1.00*_models.correctAnswer/_models.totalAnswer*100;
    zql = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(4,51,50) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:[NSString stringWithFormat:@"共   %ld   道题 答对   %ld  道题  正确率    %.0f%%   ",_models.totalAnswer,_models.correctAnswer,fen]];
    [backView addSubview:zql];
    [zql mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(ws);
        make.top.mas_equalTo(time.mas_bottom).with.offset(LENGTH(32));
    }];
}
