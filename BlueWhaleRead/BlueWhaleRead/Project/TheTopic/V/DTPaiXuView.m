...
-(void)setupUI{
    ...
    LongAn = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGBA(255,255,255,0.9) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:@"上下拖动可交换顺序"];
    ...
    [_tableView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(ws).with.offset(LENGTH(160));
        make.right.equalTo(ws).with.offset(-LENGTH(110));
