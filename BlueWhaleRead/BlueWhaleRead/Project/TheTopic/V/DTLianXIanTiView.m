...
-(void)drawRect:(CGRect)rect{
    ...
    for (NSMutableArray * array in quedingallarray) {
        ...
        CGPoint point = CGPointMake(CGRectGetMaxX(starview.frame)+LENGTH(10), starview.center.y);
        CGPoint points = CGPointMake(CGRectGetMinX(endview.frame)-LENGTH(10), endview.center.y);
