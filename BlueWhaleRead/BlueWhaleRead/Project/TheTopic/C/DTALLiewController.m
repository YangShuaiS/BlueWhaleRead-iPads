...
- (void)viewDidLoad {
    ...
    [page mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(ws.view).with.offset(StatusBar+44+LENGTH(46));
    }];
    
    bookName = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255, 255, 255) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentLeft Text:_bookname];
    ...
    [timeView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(LENGTH(178));
...
//    timetopview.backgroundColor = [UIColor redColor];
    ...
    TimeLabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255, 255, 255) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@"00:00"];
    ...
    [TimeImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self->timeView.mas_left).with.offset(-LENGTH(10));
        make.centerY.mas_equalTo(self->page.mas_centerY);
