...
-(void)setupUI{
    ...
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(51,51,51) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentCenter Text:@"在读书籍"];
