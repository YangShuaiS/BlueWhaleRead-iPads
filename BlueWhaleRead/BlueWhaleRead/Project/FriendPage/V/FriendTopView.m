...
//    inagev.layer.masksToBounds = YES;
    inagev.layer.cornerRadius = LENGTH(50);
    [self addSubview:inagev];
    
    
    UserImage  = [FLAnimatedImageView new];
    UserImage.layer.masksToBounds = YES;
    UserImage.layer.cornerRadius = LENGTH(48);
//    UserImage.layer.shadowOpacity = 0.2;

    [self addSubview:UserImage];
    
    Name = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(77,77,77) LabelFont:TextFont(30) TextAlignment:NSTextAlignmentCenter Text:@""];
    [backView addSubview:Name];
    
    BaseLabel * LVALL = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(153,153,153) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@"等级"];
    [backView addSubview:LVALL];
    
    LV = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(102, 102, 102) LabelFont:TextFont(19) TextAlignment:NSTextAlignmentCenter Text:@"lv999"];
    [backView addSubview:LV];
    
    BaseLabel * JF = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(153,153,153) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@"积分"];
    [backView addSubview:JF];
    
    JFALL = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(102, 102, 102) LabelFont:TextFont(19) TextAlignment:NSTextAlignmentCenter Text:@"999"];
    [backView addSubview:JFALL];
    
    BaseLabel * YDL = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(153,153,153) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@"阅读量"];
    [backView addSubview:YDL];
    
    YDLALL = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(102, 102, 102) LabelFont:TextFont(19) TextAlignment:NSTextAlignmentCenter Text:@"999"];
    [backView addSubview:YDLALL];
    
    BaseLabel * BJPM = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(153,153,153) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@"班级排名"];
    [backView addSubview:BJPM];
    
    BJPMALL = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(102, 102, 102) LabelFont:TextFont(19) TextAlignment:NSTextAlignmentCenter Text:@"999"];
    ...
    [backView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(ws).with.offset(LENGTH(48));
        make.right.equalTo(ws).with.offset(0);
        make.bottom.equalTo(ws).with.offset(0);
    }];
    
    [inagev mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(backView.mas_top).with.offset(-LENGTH(50));
    ...
    [UserImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(backView.mas_top).with.offset(-LENGTH(48));
        make.centerX.mas_equalTo(backView.mas_centerX);
    ...
    [LVALL mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self->Name.mas_bottom).with.offset(LENGTH(35));
