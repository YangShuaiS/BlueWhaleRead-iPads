...
- (void)addView{
    ...
    title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,114,0) LabelFont:[UIFont fontWithName:@"Jkaton" size:FontSize(LENGTH(54))] TextAlignment:NSTextAlignmentCenter Text:@"0"];
