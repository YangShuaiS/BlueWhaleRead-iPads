...
-(void)setupUI{
    ...
    [centerImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(LENGTH(234));
        make.height.mas_equalTo(LENGTH(153));
    }];
    ...
    [leftImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(self->backImageView.mas_bottom);
        make.width.mas_equalTo(LENGTH(230));
    ...
    [rightImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.mas_equalTo(self->backImageView.mas_bottom);
        make.width.mas_equalTo(LENGTH(233));
        make.height.mas_equalTo(LENGTH(86));
    }];
    
    xunZhangLabeOne = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentLeft Text:@"勋章"];
    [centerImageView addSubview:xunZhangLabeOne];
    
    xunZhangLabeTwo = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentLeft Text:@"勋章"];
    [leftImageView addSubview:xunZhangLabeTwo];
    
    xunZhangLabeThree = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentLeft Text:@"勋章"];
    ...
    touxiangone.layer.cornerRadius = LENGTH(47);
    ...
    [touxiangone mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(centerImageView.mas_top).with.offset(-LENGTH(44));
        make.centerX.mas_equalTo(centerImageView.mas_centerX);
        make.width.mas_equalTo(LENGTH(94));
    ...
    touxiangtwo.layer.cornerRadius = LENGTH(42);
    ...
    [touxiangtwo mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(leftImageView.mas_top).with.offset(-LENGTH(50));
        make.centerX.mas_equalTo(leftImageView.mas_centerX);
        make.width.mas_equalTo(LENGTH(84));
        make.height.mas_equalTo(LENGTH(84));
    }];
    ...
    touxianthree.layer.cornerRadius = LENGTH(37);
    ...
    [touxianthree mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(rightImageView.mas_top).with.offset(-LENGTH(50));
        make.centerX.mas_equalTo(rightImageView.mas_centerX);
    ...
    BaseLabel * name1 = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentCenter Text:@"虚位以待"];
    [rightImageView addSubview:name1];
    
    BaseLabel * name2 = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentCenter Text:@"虚位以待"];
    [rightImageView addSubview:name2];
    
    BaseLabel * name3 = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentCenter Text:@"虚位以待"];
    ...
    [name1 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(touxiangone.mas_bottom).with.offset(LENGTH(10));
    }];
    [name2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(touxiangtwo.mas_centerX);
        make.top.mas_equalTo(touxiangtwo.mas_bottom).with.offset(LENGTH(12));
    }];
    [name3 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(touxianthree.mas_centerX);
        make.top.mas_equalTo(touxianthree.mas_bottom).with.offset(LENGTH(12));
    }];
    ...
    [topimageone mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(LENGTH(topimageone.image.size.width));
        make.height.mas_equalTo(LENGTH(topimageone.image.size.height));
    }];
    
    [topimagetwo mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(touxiangtwo.mas_centerX);
        make.bottom.mas_equalTo(touxiangtwo.mas_top).with.offset(LENGTH(0));
        make.width.mas_equalTo(LENGTH(topimagetwo.image.size.width));
        make.height.mas_equalTo(LENGTH(topimagetwo.image.size.height));
    }];
    ...
    [topimagethree mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(LENGTH(topimagethree.image.size.width));
        make.height.mas_equalTo(LENGTH(topimagethree.image.size.height));
    }];
...
- (void)addall{
    BaseLabel * title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(164,108,10) LabelFont:TextFont(30) TextAlignment:NSTextAlignmentCenter Text:@"月勋章排行"];
    [backImageView addSubview:title];
    
    [title mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self->backImageView.mas_centerX);
        make.top.mas_equalTo(self->backImageView.mas_top).with.offset(LENGTH(30));
    }];
    
    userImage = [FLAnimatedImageView new];
    userImage.image = UIIMAGE(ZHANWEITUTX);
    userImage.layer.masksToBounds = YES;
    userImage.layer.cornerRadius = LENGTH(21);
    userImage.layer.borderColor = [UIColor whiteColor].CGColor;
    userImage.layer.borderWidth = LENGTH(2);
    [backImageView addSubview:userImage];
    [userImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self->backImageView.mas_top).with.offset(LENGTH(16));
        make.right.mas_equalTo(self->backImageView.mas_right).with.offset(-LENGTH(76));
        make.width.mas_equalTo(LENGTH(42));
        make.height.mas_equalTo(LENGTH(42));
    }];
    
    UserName = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(191,132,29) LabelFont:TextFont(15) TextAlignment:NSTextAlignmentCenter Text:@"我在第 30 名"];
    [backImageView addSubview:UserName];
    [UserName mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self->userImage.mas_bottom).with.offset(LENGTH(6));
    ...
    [rightClick mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self->userImage.mas_right).with.offset(LENGTH(10));
//        make.width.mas_equalTo(LENGTH(rightClick.image.size.width));
//        make.height.mas_equalTo(LENGTH(rightClick.image.size.height));
    }];
...
-(void)setMonthBadgeList:(FoundMonthModel *)monthBadgeList{
    ...
    if (monthBadgeList.studentList.count>xunzhangarray.count) {
        ...
        for (int i = 0; i < 3; i++) {
            MyClassModel * model = monthBadgeList.studentList[i];
