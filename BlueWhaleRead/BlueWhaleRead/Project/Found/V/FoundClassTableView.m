...
@interface FoundClassTableView ()<UITableViewDelegate,UITableViewDataSource>

@end
@implementation FoundClassTableView
...
{
    NSString * rid = @"cell";
    FoundClassTableViewCell * cell =[tableView dequeueReusableCellWithIdentifier:rid];
    if(cell==nil){
        cell=[[FoundClassTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:rid];
    }
    cell.nav = self.nav;
...
//                           ];
//    for (FoundClassTableViewCell * cell in cellarray) {
