...
//        userimageOne.image = UIIMAGE(ZHANWEITUTX);
        ...
        userimageOne.layer.cornerRadius = LENGTH(44);
        ...
        [userimageOne mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo(LENGTH(88));
...
//            userimageTwo.image = UIIMAGE(ZHANWEITUTX);
            ...
            userimageTwo.layer.cornerRadius = LENGTH(30);
            ...
            if (a == 0) {
                [userimageTwo mas_makeConstraints:^(MASConstraintMaker *make) {
                    make.centerY.mas_equalTo(userimageOne.mas_centerY).with.offset(-LENGTH(100));
                    make.centerX.mas_equalTo(userimageOne.mas_centerX).with.offset(LENGTH(150));
                    
                }];
            }else if (a == 1){
                [userimageTwo mas_makeConstraints:^(MASConstraintMaker *make) {
                    make.centerY.mas_equalTo(userimageOne.mas_centerY).with.offset(LENGTH(0));
                    make.centerX.mas_equalTo(userimageOne.mas_centerX).with.offset(LENGTH(170));
