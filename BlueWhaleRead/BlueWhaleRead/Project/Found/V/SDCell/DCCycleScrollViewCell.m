...
//
        ...
        title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:WhitColor LabelFont:TextFont(25) TextAlignment:NSTextAlignmentLeft Text:@""];
        [self addSubview:title];
        
        name = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:WhitColor LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@""];
        [self addSubview:name];
        
        zaidu = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:WhitColor LabelFont:TextFont(18) TextAlignment:NSTextAlignmentLeft Text:@""];
        ...
        [_imageView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(view.mas_left).with.offset(LENGTH(35));
            make.top.mas_equalTo(view.mas_top).with.offset(LENGTH(40));
            make.bottom.mas_equalTo(view.mas_bottom).with.offset(-LENGTH(40));
            make.width.mas_equalTo(LENGTH(101));
        }];
        
        [title mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(ws.imageView.mas_top).with.offset(LENGTH(6));
            make.left.mas_equalTo(ws.imageView.mas_right).with.offset(LENGTH(30));
        ...
        [zaidu mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.mas_equalTo(view.mas_right).with.offset(-LENGTH(27));
        }];
        
        UICollectionViewFlowLayout *flowLayouts = [[UICollectionViewFlowLayout alloc] init];
        flowLayouts.itemSize = CGSizeMake(LENGTH(46),LENGTH(46));
        //定义每个UICollectionView 横向的间距
        flowLayouts.minimumLineSpacing = LENGTH(10);
        //定义每个UICollectionView 纵向的间距
        flowLayouts.minimumInteritemSpacing = LENGTH(10);
        ...
        [touxiang mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(ws.imageView.mas_right).with.offset(LENGTH(26));
