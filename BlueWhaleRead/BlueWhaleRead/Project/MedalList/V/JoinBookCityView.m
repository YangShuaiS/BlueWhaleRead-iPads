...
- (void)addView{
    ...
    //为了那个正常显示动画
    tableView = [[JoinBookCitytableView alloc] initWithFrame:CGRectMake(0, HEIGHT, WIDTH, HEIGHT-LENGTH(134))];
    tableView.layer.masksToBounds = YES;
    tableView.layer.cornerRadius = LENGTH(10);
    [self addSubview:tableView];
    tableView.hidden = YES;
    
    _joinDown = [[JoinDownView alloc] initWithFrame:CGRectMake(0, HEIGHT, WIDTH, LENGTH(86))];
...
//    clickImage.backgroundColor = RANDOMCOLOR;
    ...
    [clickImage mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self->backView.mas_top).with.offset(StatusBar+44+LENGTH(22));
    ...
    [clickButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self->backView.mas_top).with.offset(StatusBar+44+LENGTH(22-15));
...
- (void)quxiao{
    ...
    [UIView animateWithDuration:1 animations:^{
        ...
        CGRect frame = CGRectMake(0, HEIGHT, WIDTH, HEIGHT-LENGTH(134));
        self->tableView.frame = frame;
        CGRect framejo = CGRectMake(0, HEIGHT, WIDTH, LENGTH(86));
...
- (void)animationBegin{
    ...
    [UIView animateWithDuration:0.5 animations:^{
        ...
        frame.origin.y = StatusBar+44+LENGTH(70);
        self->tableView.frame = frame;
        
        CGRect framejo = self.joinDown.frame;
        framejo.origin.y = HEIGHT-LENGTH(86);
        self.joinDown.frame = framejo;
    } completion:^(BOOL finished) {
