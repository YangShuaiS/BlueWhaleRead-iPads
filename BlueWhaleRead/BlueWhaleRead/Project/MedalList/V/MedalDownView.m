...
- (void)LightUp{
    ...
    titlelabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:WhitColor LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@""];
    titlelabel.backgroundColor = RGB(1,195,193);
    titlelabel.layer.masksToBounds = YES;
    titlelabel.layer.cornerRadius = LENGTH(49)/2;
    [self addSubview:titlelabel];
    [titlelabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(ws).with.offset(LENGTH(133));
        make.right.mas_equalTo(ws).with.offset(-LENGTH(133));
