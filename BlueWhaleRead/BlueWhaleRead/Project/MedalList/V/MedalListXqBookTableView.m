...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    BaseLabel * label = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@""];
    ...
    [label mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(v.mas_top).with.offset(LENGTH(29));
        make.left.mas_equalTo(v.mas_left).with.offset(LENGTH(26));
        make.right.mas_equalTo(v.mas_right).with.offset(-LENGTH(43));
    }];
    return v;
}
