...
//        }];
        ...
        myMedal = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(252,244,140) LabelFont:TextFont(13) TextAlignment:NSTextAlignmentCenter Text:@"我的勋章"];
        ...
        [BookList mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.mas_equalTo(self->MedalView.mas_right).with.offset(LENGTH(45));
            make.right.mas_equalTo(ws.mas_right).with.offset(-LENGTH(58));
