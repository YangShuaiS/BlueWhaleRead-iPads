...
-(void)setupUI{
    ...
    [backView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(ws).mas_equalTo(LENGTH(12));
        make.left.mas_equalTo(ws).mas_equalTo(LENGTH(26));
        make.right.mas_equalTo(ws).mas_equalTo(-LENGTH(26));
...
//    }];
    ...
    [TXImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->backImage.mas_bottom).with.offset(LENGTH(26));
        make.left.equalTo(self->backView.mas_left).with.offset(LENGTH(20));
        make.width.mas_equalTo(LENGTH(self->TXImage.image.size.width));
        make.height.mas_equalTo(LENGTH(self->TXImage.image.size.height));
        make.bottom.equalTo(self->backView.mas_bottom).with.offset(-LENGTH(33));
    }];
    ...
    [subtitle mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self->TXImage.mas_right).with.offset(LENGTH(8));
        make.right.equalTo(self->backView.mas_right).with.offset(-LENGTH(200));
        make.centerY.mas_equalTo(self->TXImage.mas_centerY);
    }];
    
    noshuju = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@""];
    [backView addSubview:noshuju];
    [noshuju mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self->backView.mas_left).with.offset(LENGTH(8));
        make.right.equalTo(self->backView.mas_right).with.offset(-LENGTH(8));
        make.centerY.mas_equalTo(self->TXImage.mas_centerY);
    }];
...
//    }];
    ...
    [touxiang mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->backImage.mas_bottom).with.offset(LENGTH(10));
        make.right.equalTo(self->backView.mas_right).with.offset(-LENGTH(23));
