...
- (void)NoDtaaViewStyleImageLabelClick{
    ...
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(LENGTH(135));
    }];
...
- (void)addTitle{
    title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(4,51,50) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:_titlename];
    title.numberOfLines = 0;
    [self addSubview:title];
}
- (void)addcliCkTitle{
    clickTitle = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(9,187,180) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:_clickName];
    clickTitle.backgroundColor = WhitColor;
    clickTitle.layer.masksToBounds = YES;
    clickTitle.layer.cornerRadius = LENGTH(25);
