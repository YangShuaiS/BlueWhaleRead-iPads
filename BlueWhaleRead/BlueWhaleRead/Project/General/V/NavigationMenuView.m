...
- (void)addView{
    ...
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFontCu(22) TextAlignment:NSTextAlignmentLeft Text:@""];
...
- (void)addRightlabel{
    WS(ws);
        huanyihuan = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(Font16) TextAlignment:NSTextAlignmentLeft Text:@""];
        ...
        [huanyihuan mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.equalTo(ws).with.offset(-LENGTH(27));
        }];
