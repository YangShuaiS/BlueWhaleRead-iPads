...
- (void)addview{
    ...
    time = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(15) TextAlignment:NSTextAlignmentRight Text:@""];
    [self addSubview:time];
    
    userimage = [FLAnimatedImageView new];
    userimage.image = UIIMAGE(ZHANWEITUTX);
    userimage.layer.masksToBounds = YES;
    userimage.layer.cornerRadius = LENGTH(14);
