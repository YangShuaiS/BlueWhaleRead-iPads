...
- (void)addview{
    ...
    leftImage.layer.cornerRadius = LENGTH(10);
    ...
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(23) TextAlignment:NSTextAlignmentLeft Text:@""];
...
//    [self addSubview:xunzhangshu];
    ...
    rentoushu = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(15) TextAlignment:NSTextAlignmentLeft Text:CHANGWENZI];
...
- (void)updata{
    ...
    [Title mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self->leftImage.mas_right).with.offset(LENGTH(17));
    }];
...
//    }];
    ...
    [SubTitle mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->Title.mas_bottom).with.offset(LENGTH(28));
...
//    }];
    ...
    [rentou mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(ws).with.offset(-LENGTH(190));
        make.height.mas_equalTo(self->rentou.image.size.height);
        make.width.mas_equalTo(self->rentou.image.size.width);
        make.centerY.mas_equalTo(self->Title.mas_centerY);
    }];
