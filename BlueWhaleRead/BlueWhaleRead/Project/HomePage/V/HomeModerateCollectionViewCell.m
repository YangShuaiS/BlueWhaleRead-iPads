...
-(void)setupUI{
    ...
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(21) TextAlignment:NSTextAlignmentCenter Text:@""];
    [self addSubview:Title];
    
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(ws.mas_top).with.offset(4);
        make.left.equalTo(ws.mas_left).with.offset(4);
        make.right.equalTo(ws.mas_right).with.offset(-4);
