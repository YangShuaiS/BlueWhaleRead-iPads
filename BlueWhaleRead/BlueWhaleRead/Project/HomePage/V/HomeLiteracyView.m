...
//            model.title、
    ...
    CGFloat padding = LENGTH(29);
    [array mas_distributeViewsAlongAxis:MASAxisTypeHorizontal withFixedSpacing:padding leadSpacing:LENGTH(26) tailSpacing:LENGTH(26)];
    [array mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->backView.mas_top).offset(LENGTH(27));
        make.height.mas_equalTo(LENGTH(141));
        make.bottom.equalTo(self->backView.mas_bottom).offset(-LENGTH(27));
    }];
}
