...
-(void)setupUI{
    ...
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(21) TextAlignment:NSTextAlignmentLeft Text:@""];
...
//    [self.contentView addSubview:touxiangview];
    ...
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self->backView.mas_left).with.offset(4);
        make.right.equalTo(self->backView.mas_right).with.offset(-4);
        make.height.mas_equalTo(self->imageView.mas_width).multipliedBy(1.4133333);
    }];
    
    [Title mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->imageView.mas_bottom).with.offset(LENGTH(21));
...
//    }];
    ...
    flowLayout.itemSize = CGSizeMake(LENGTH(33),LENGTH(53));
