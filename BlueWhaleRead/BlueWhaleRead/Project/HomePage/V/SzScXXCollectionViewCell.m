...
-(void)setupUI{
    ...
    self.layer.cornerRadius = LENGTH(50);
    
    namelabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(85,137,230) LabelFont:TextFont(50) TextAlignment:NSTextAlignmentCenter Text:@""];
