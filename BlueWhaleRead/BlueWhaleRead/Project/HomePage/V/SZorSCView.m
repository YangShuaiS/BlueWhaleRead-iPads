...
#define itemWidth LENGTH(180)
#define itemHeight LENGTH(180)
...
- (void)addView{
    ...
    tiMu.layer.cornerRadius = LENGTH(40);
    ...
    title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255, 255, 255) LabelFont:TextFont(24) TextAlignment:NSTextAlignmentLeft Text:@""];
    ...
    [tiMuImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(ws).with.offset(LENGTH(92)+StatusBar+44);
        make.centerX.mas_equalTo(ws);
        make.width.mas_equalTo(LENGTH(215));
        make.height.mas_equalTo(LENGTH(215));
    ...
    flowLayout.minimumLineSpacing = LENGTH(50);
    //定义每个UICollectionView 纵向的间距
    flowLayout.minimumInteritemSpacing = LENGTH(50);
    ...
    [_collectView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.mas_equalTo(ws);
        make.height.mas_equalTo(itemHeight*2+LENGTH(50));
        make.width.mas_equalTo(itemHeight*2+LENGTH(50));
    }];
    ...
    [nexttopic mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(ws.collectView.mas_bottom).with.offset(LENGTH(80));
        make.centerX.mas_equalTo(ws);
        make.width.mas_equalTo(LENGTH(160));
        make.height.mas_equalTo(LENGTH(68));
    }];
    
    BaseLabel * Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@"下一题"];
    Title.numberOfLines = 0;
...
//    }];
    ...
    BaseLabel * Titles = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,255,255) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@"提交答案"];
