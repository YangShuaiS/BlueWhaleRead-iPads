...
- (void)AddView{
    ...
    [tiMu mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(ws.view).with.offset(LENGTH(87)+StatusBar+44);
        make.left.equalTo(ws.view).with.offset(LENGTH(52));
        make.right.equalTo(ws.view ).with.offset(-LENGTH(52));
    }];
    NSString * str = @"";
    ...
    titles = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255, 255, 255) LabelFont:TextFont(24) TextAlignment:NSTextAlignmentCenter Text:str];
    ...
    [RJOrFanHuiBookCity mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->tiMu.mas_bottom).with.offset(LENGTH(90));
