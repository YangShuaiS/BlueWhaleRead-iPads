...
//    }];
    ...
    name = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(8,8,8) LabelFont:TextFont(30) TextAlignment:NSTextAlignmentCenter Text:@""];
    ...
    time = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(182,181,181) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@"2012-12-12"];
...
//    down = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:[UIColor blackColor] LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@""];
