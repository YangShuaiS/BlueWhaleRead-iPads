...
//            make.top.mas_equalTo(ws.mas_bottom).with.offset(-LENGTH(28));
            make.bottom.mas_equalTo(ws).with.offset(-LENGTH(139));
        ...
        [qximage mas_makeConstraints:^(MASConstraintMaker *make) {
            make.width.and.height.mas_equalTo(LENGTH(52));
            make.centerX.mas_equalTo(ws);
            make.top.mas_equalTo(self->pageControl.mas_bottom).with.offset(LENGTH(32));
        }];
