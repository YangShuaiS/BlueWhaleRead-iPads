    ...
    for (ZhiShiShuViTypeModel * model in itemarray) {
        ...
        [view mas_makeConstraints:^(MASConstraintMaker *make) {
            if (!lastlabel) {
                ...
                make.left.mas_equalTo(lastlabel.mas_right).with.offset(LENGTH(15));
            }
        ...
        BaseLabel * label = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:[BaseObject colorWithHexString:_textcolor] LabelFont:TextFontCu(17) TextAlignment:NSTextAlignmentLeft Text:model.name];
