...
//    self.layer.shadowOffset = CGSizeMake(4,4);
    ...
    leftImage.layer.shadowRadius = 4.f;
    leftImage.layer.shadowOffset = CGSizeMake(0,0);
    leftImage.contentMode = UIViewContentModeScaleAspectFit;
    leftImage.image = UIIMAGE(ZHANWEITUSHU);
    [self addSubview:leftImage];
    
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(4,51,50) LabelFont:TextFont(22) TextAlignment:NSTextAlignmentLeft Text:@""];
    ...
    subtitle = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(137,159,159) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentLeft Text:@""];
    [self addSubview:subtitle];
    
    fuwenben = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(137,159,159) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentLeft Text:@"阅读分级: 0   分值: 0"];
...
- (void)addsjwd{
    ...
    [caozuo mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(ws);
        make.right.equalTo(ws).with.offset(-LENGTH(90));
    }];
...
- (void)likeYD{
    if (like == nil) {
        ...
        like = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(137,159,159) LabelFont:TextFont(Font15) TextAlignment:NSTextAlignmentLeft Text:@"喜欢"];
        ...
        nolike = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(137,159,159) LabelFont:TextFont(Font15) TextAlignment:NSTextAlignmentLeft Text:@"不喜欢"];
        ...
        [nolikeimage mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.mas_equalTo(self->nolike.mas_left).with.offset(-LENGTH(10));
//            make.bottom.mas_equalTo(ws).with.offset(-LENGTH(20));
        ...
        [like mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.mas_equalTo(self->nolikeimage.mas_left).with.offset(-LENGTH(24));
            make.bottom.mas_equalTo(ws).with.offset(-LENGTH(20));
        }];
        
        [likeimage mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.mas_equalTo(self->like.mas_left).with.offset(-LENGTH(10));
//            make.bottom.mas_equalTo(ws).with.offset(-LENGTH(20));
