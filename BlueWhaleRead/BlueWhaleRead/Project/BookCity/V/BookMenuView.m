...
-(void)setupUI{
    ...
    ydfj = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(4,51,50) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@"阅读分级"];
    ...
    sjlx = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(4,51,50) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@"书籍类型"];
    ...
    mrpx = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(4,51,50) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@"默认排序"];
