...
//    self.layer.borderColor = [UIColor grayColor].CGColor;
    WS(ws);
    BaseLabel * onexian = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(50,73,73) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:@"阅读均衡等级对照表"];
