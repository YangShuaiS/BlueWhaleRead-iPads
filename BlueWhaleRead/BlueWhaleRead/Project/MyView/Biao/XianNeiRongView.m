...
- (void)addTitle{
    ...
    for (int i = 0; i < labeletitle.count; i++) {
        BaseLabel * label = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(102,102,102) LabelFont:TextFont(19) TextAlignment:NSTextAlignmentCenter Text:labeletitle[i]];
...
- (void)addNeirong{
    ...
    for (int i = 0; i < labeletitle.count; i++) {
        ...
        BaseLabel * label = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(102,102,102) LabelFont:TextFont(19) TextAlignment:NSTextAlignmentCenter Text:str];
        //    onexian.lineBreakMode = NSLineBreakByTruncatingTail;
//        label.layer.borderWidth = 0.5;
//        label.layer.borderColor = [UIColor blackColor].CGColor;
        [labelarray addObject:label];
