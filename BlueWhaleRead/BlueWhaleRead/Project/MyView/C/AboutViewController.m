...
//    imageView.backgroundColor = RGB(90,196,192);
    ...
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self->scrollView.mas_top).with.offset(LENGTH(75));
        make.width.mas_equalTo(LENGTH(130));
        make.height.mas_equalTo(LENGTH(130));
    }];
    
    BaseLabel * bbh = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(102,102,102) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:BANBENHAO];
    ...
    BaseLabel * title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(102,102,102) LabelFont:TextFont(23) TextAlignment:NSTextAlignmentLeft Text:str];
    title.numberOfLines = 0;
    [scrollView addSubview:title];
    [title mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(ws.view).with.offset(LENGTH(50));
        make.right.equalTo(ws.view).with.offset(-LENGTH(50));
        make.top.equalTo(bbh.mas_bottom).with.offset(LENGTH(62));
        make.bottom.equalTo(self->scrollView.mas_bottom).with.offset(-LENGTH(40));
    }];
}
