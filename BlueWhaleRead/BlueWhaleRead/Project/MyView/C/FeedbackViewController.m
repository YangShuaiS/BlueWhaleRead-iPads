...
- (void)Addview{
    ...
    [backVie mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(LENGTH(388));
    }];
    ...
    textview.font=TextFont(20); //设置字体名字和字体大小;
    textview.textColor = RGB(51,51,51);
    textview.textAlignment = NSTextAlignmentLeft;
    textview.text = @"";//设置显示的文本内容
    textview.layer.masksToBounds = YES;
    textview.layer.cornerRadius = LENGTH(20);
//    textview.
    [backVie addSubview:textview];
    [textview mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(backVie.mas_top).with.offset(LENGTH(40));
        make.left.mas_equalTo(backVie.mas_left).with.offset(LENGTH(40));
        make.right.mas_equalTo(backVie.mas_right).with.offset(-LENGTH(40));
        make.bottom.mas_equalTo(backVie.mas_bottom).with.offset(-LENGTH(40));

    }];
    
    _placeholderLabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(51,51,51) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@"200字内"];
    [backVie addSubview:_placeholderLabel];
    [_placeholderLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(backVie.mas_left).with.offset(LENGTH(45));
        make.top.mas_equalTo(backVie.mas_top).with.offset(LENGTH(40));
    }];
    ...
    dl.layer.cornerRadius = LENGTH(25);
    [self.view addSubview:dl];
    [dl mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(ws.view);
        make.top.mas_equalTo(backVie.mas_bottom).with.offset(LENGTH(80));
