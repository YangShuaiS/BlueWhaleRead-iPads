...
-(void)setupUI{
    ...
    imageView.layer.cornerRadius = LENGTH(105/2);
    ...
    content = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:WhitColor LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:[NSString stringWithFormat:@"%@\n%@",ZHANWEIZI,ZHANWEIZI]];
    ...
    name = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(20) TextAlignment:NSTextAlignmentCenter Text:ZHANWEIZI];
