...
-(void)setupUI{
    ...
    paiminglabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255,175,89) LabelFont:TextFont(25) TextAlignment:NSTextAlignmentLeft Text:@""];
    ...
    name = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:@""];
    [self addSubview:name];
    [name mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(ws).with.offset(LENGTH(20));
        make.left.mas_equalTo(self->Touxiang.mas_right).with.offset(LENGTH(23));
    ...
    [self addSubview:touxiang];
    jf = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(137,159,159) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@""];
    [self addSubview:jf];
    [touxiang mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->name.mas_bottom).with.offset(LENGTH(18));
        make.left.mas_equalTo(self->Touxiang.mas_right).with.offset(LENGTH(30));
        make.right.mas_equalTo(self->jf.mas_left).with.offset(-LENGTH(30));
...
//    
    ...
    [jf mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(ws.mas_centerY);
        make.left.mas_equalTo(ws).with.offset(LENGTH(400));
        
    }];
    
    
    ydl = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(137,159,159) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@""];
    [self addSubview:ydl];
    [ydl mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(ws.mas_centerY).with.offset(-LENGTH(25));
        make.left.mas_equalTo(ws).with.offset(LENGTH(530));
    }];
    
    byydl = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(137,159,159) LabelFont:TextFont(20) TextAlignment:NSTextAlignmentLeft Text:@""];
