...
-(void)setupUI{
    ...
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(LENGTH(194));
    }];
    ...
    Title.font = [UIFont fontWithName:@"JSaoEr" size:FontSize(LENGTH(37))];
    Title.textAlignment = NSTextAlignmentCenter;
    [imageView addSubview:Title];
    [Title mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self->imageView.mas_centerX);
        make.top.mas_equalTo(self->imageView.mas_top).with.offset(LENGTH(60));
    }];
    ...
    subTitle.font = [UIFont fontWithName:@"JSaoEr" size:FontSize(LENGTH(37))];
    subTitle.textAlignment = NSTextAlignmentCenter;
    [imageView addSubview:subTitle];
    [subTitle mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self->imageView.mas_centerX);
        make.bottom.mas_equalTo(self->imageView.mas_bottom).with.offset(-LENGTH(40));
    }];
