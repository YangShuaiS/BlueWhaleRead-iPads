...
#define itemWidth LENGTH(105)
#define itemHeight LENGTH(105)+LENGTH(62)
...
-(void)setupUI{
    ...
    titles = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(22) TextAlignment:NSTextAlignmentLeft Text:@""];
    ...
    [_collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self->titles.mas_bottom).with.offset(LENGTH(26));
...
- (UICollectionView *)collectionView {
    if (_collectionView == nil) {
        ...
        flowLayout.minimumLineSpacing = LENGTH(38);
        //定义每个UICollectionView 纵向的间距
        flowLayout.minimumInteritemSpacing = LENGTH(38);
        //定义每个UICollectionView 的边距距
        flowLayout.sectionInset = UIEdgeInsetsMake(0, LENGTH(50), 0, LENGTH(50));//上左下右
