...
-(void)setupUI{
    ...
    userImageView.layer.cornerRadius = LENGTH(75);
    [backView addSubview:userImageView];
    [userImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.center.mas_equalTo(backView);
        make.top.mas_equalTo(backView.mas_top).with.offset(LENGTH(70));
        make.bottom.mas_equalTo(backView.mas_bottom).with.offset(-LENGTH(76));
        make.width.mas_equalTo(LENGTH(150));
        make.height.mas_equalTo(LENGTH(150));
    }];
    ...
    [shezhi mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(backView.mas_top).with.offset(LENGTH(32));
        make.right.mas_equalTo(backView.mas_right).with.offset(LENGTH(-60));
