...
-(void)setupUI{
    ...
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(ws).with.offset(LENGTH(38));
...
//    }];
    ...
    title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFont(22) TextAlignment:NSTextAlignmentCenter Text:@""];
    ...
    time = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(137,159,159) LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@""];
    ...
    [MedalZt mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(ws.mas_right).with.offset(-LENGTH(22));
        make.width.mas_equalTo(LENGTH(80));
        make.height.mas_equalTo(LENGTH(24));
    }];
    
    medalLabel = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:WhitColor LabelFont:TextFont(18) TextAlignment:NSTextAlignmentCenter Text:@"点亮中"];
    ...
    [medalLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.edges.mas_equalTo(self->MedalZt).with.insets(UIEdgeInsetsMake(LENGTH(2), LENGTH(2), LENGTH(2), LENGTH(2)));
    }];
    
    UICollectionViewFlowLayout *flowLayout = [[UICollectionViewFlowLayout alloc] init];
    flowLayout.itemSize = CGSizeMake(LENGTH(53),LENGTH(63));
    ...
    [BookList mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self->imageView.mas_right).with.offset(LENGTH(20));
        make.right.mas_equalTo(ws).with.offset(-LENGTH(125));
    ...
    MyImage.layer.cornerRadius = LENGTH(25);
    MyImage.image = UIIMAGE(@"ZHANWEITUXZ");
    [self addSubview:MyImage];
    [MyImage mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(xian.mas_bottom).with.offset(LENGTH(10));
        make.left.mas_equalTo(ws).with.offset(LENGTH(29));
    ...
    [UserName mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self->MyImage.mas_bottom).with.offset(LENGTH(8));
    ...
    flowLayout1.itemSize = CGSizeMake(LENGTH(47),LENGTH(75));
    //定义每个UICollectionView 横向的间距
    flowLayout1.minimumLineSpacing = LENGTH(9);
    //定义每个UICollectionView 纵向的间距
    flowLayout1.minimumInteritemSpacing = LENGTH(9);
    //定义每个UICollectionView 的边距距
