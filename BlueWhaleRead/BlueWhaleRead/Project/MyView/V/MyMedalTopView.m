...
//    backImageView.backgroundColor = RANDOMCOLOR;
    ...
    [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(LENGTH(205));
        make.height.mas_equalTo(LENGTH(205));
    }];
    ...
    Title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFontling(23) TextAlignment:NSTextAlignmentCenter Text:@""];
    ...
    flowLayout.itemSize = CGSizeMake(LENGTH(47),LENGTH(47));
...
//    }];
    ...
    ydreiend = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFontling(15) TextAlignment:NSTextAlignmentLeft Text:@"300人点亮中"];
    ...
    [ydreiend mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self->touxiang.mas_right).with.offset(LENGTH(5));
        make.right.equalTo(ws).with.offset(0);
    }];
    
    BaseLabel * label = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:ChangYongTitLe LabelFont:TextFontling(23) TextAlignment:NSTextAlignmentCenter Text:@"本周最受欢迎勋章"];
    [self addSubview:label];
    [label mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(self->touxiang.mas_top).with.offset(-LENGTH(10));
        make.left.equalTo(ws).with.offset(0);
        make.right.equalTo(ws).with.offset(0);
